...
with open('sensor.csv', 'r') as file:
    ...
    plt.plot(threshold, list_sent, label='LA', color='#ff4400')
    plt.plot(threshold, list_sent1, label='MA(2)', color='#1ea84c')
    plt.legend()
    plt.xlabel('THRESHOLD')
    plt.ylabel('DATA_SENT(%)')
    plt.title('LP/MA(2) Frequency 1')
    plt.show()
    ...
    plt.plot(threshold, listfreq3_sent,label='LA',color='#ff4400')
    plt.plot(threshold, listfreq5_sent,label='MA(2)', color='#1ea84c')
    plt.legend()
    plt.xlabel('THRESHOLD')
    plt.ylabel('DATA_SENT(%)')
    plt.title('LP/MA(2) Frequency 3')
    plt.show()

    plt.figure(num='Frequency - 5')
    plt.plot(threshold, listfreq5_sent,label='LA',color='#ff4400')
    plt.plot(threshold, listfreq5_sent1,label='MA(2)', color='#1ea84c')
    plt.legend()
    plt.xlabel('THRESHOLD')
    plt.ylabel('DATA_SENT(%)')
    plt.title('LA/MA(2) Frequency 5')
    plt.show()
